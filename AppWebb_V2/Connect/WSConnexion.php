									...
									<div id="Menu_top" >
										<div id="Menu_top_1">
											...
											<form name="Connect" id="InscriptionUser" method="post" action="WSConnexion.php">
												<input class="Box" style="left: 50%; top:0px; " name="Pseudo" type="text" placeholder="Pseudo" AUTOCOMPLETE=OFF  autofocus onblur="verifLenght1(this)" required><br>
												<input class="Box" style="left: 50%; top:0px; " name="Password" type="Password" placeholder="Password" AUTOCOMPLETE=OFF onblur="verifLenght1(this)" required><br><br>
