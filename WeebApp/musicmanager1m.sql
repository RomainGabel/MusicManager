...
--
-- Client: localhost
-- Généré le: Ven 01 Février 2013 à 07:48
...
CREATE TABLE `inter_user_chanson` (
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`IdUser`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Table contenant les utilisateurs du site web' AUTO_INCREMENT=3 ;
